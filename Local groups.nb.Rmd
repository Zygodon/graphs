...
```{r echo = F, warning = F, message = F, fig.fullwidth = TRUE}
...
On this basis, more than 100 plant pairs were significantly more strogky associated at the quadrat-level than would be expected from the observed stand-level association.
